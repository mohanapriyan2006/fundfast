        ...
        <View style={{ flex: 1, backgroundColor: accent.DEFAULT }}>
            <ScrollView style={{ flex: 1 }}>
                ...
                <View style={styles.formContainer}>
                    ...
                    {/* Name */}
                    <TextInput placeholder='Name' placeholderTextColor={"#6e6e6eff"} style={styles.input} />

                    {/* Username */}
                    <TextInput placeholder='Username' placeholderTextColor={"#6e6e6eff"} style={styles.input} />

                    {/* Email */}
                    <TextInput placeholder='Email' placeholderTextColor={"#6e6e6eff"} style={styles.input} />
